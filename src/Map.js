...
const data = [
  {
    ...
    content:
      "Nuestros planteles de crianza cuentan con la más avanzada tecnología por que estamos 100% comprometidos con el bienestar animal, velando por el cumplimiento de las 5 libertades propuestas por la Organización Mundial de Sanidad Animal (OIE).",
    banner: banner1,
  },
  {
    title: "Oficina Central",
    content:
      "Nuestras oficinas centrales están ubicadas en Doñihue. En este lugar se encuentra la mayoria de nuestros departamentos ejecutivos, desde donde controlamos aspectos de la producción, gestión y comunicación de cada una de las marcas de Agrosuper. En conjunto hoy día contamos con una dotación de más de 13.282 colaboradores. ",
    banner: banner2,
  },
  {
    title: "Nuestra Historia",
    content:
      "Nuestro camino comienza en el año 1955 con la producción de huevos frescos en una pequeña granja de Doñihue, en la región de O`Higgins. Con el paso del tiempo incorporamos la producción de pollo, cerdo, salmones y mucho más, hasta construir las marcas que hoy todos conocen.",
    banner: banner3,
  },
  {
    title: "Comunidades",
    content:
      "Somos orgullosos del entorno al que pertenecemos y como nos relacionamos con nuestras comunidades. A través de diferentes programas buscamos ayudar y aportar nuestro grano de arena en el desarrollo de la sociedad en su conjunto y sobre todo de aquellos que más lo necesitan.",
    banner: banner4,
  },
  {
    title: "Producción Responsable",
    content:
      "Somos conscientes que debemos hacernos responsables de los residuos de nuestra producción. Es por ello que contamos con plantas de tratamientos para desechos sólidos y líquidos que nos permiten reducir nuestras emisiones y de paso ayudar a la comunidad con el producto útil del tratamiento de estos elementos. ",
    banner: banner5,
  },
  {
    title: "Plantas Industriales",
    content:
      "En nuestras fabricas ocurren todos los procesos industriales de nuestras diferentes áreas de negocio. Junto a lo último de la tecnología de la mano con altos estandares de calidad nos permiten llevar a las mesas de Chile y el mundo la mejor proteína.",
    banner: banner6,
  },
];
